...
export const serverConfig = {
  ...
  baseURL: import.meta.env.VITE_API_BASE_URL || 'http://localhost:3000/MeetingBookingApi/api/v1',
  
  // Backend server URL (for WebSocket connections, etc.)
  serverURL: import.meta.env.VITE_SERVER_URL || 'http://localhost:3000/MeetingBookingApi',
